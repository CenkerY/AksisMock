    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                ...
                else if (1 < this.numberDisplayed) {
            ...
            nonSelectedText: 'Seciniz',
            nSelectedText: 'secili',
            allSelectedText: 'Hepsi',
            numberDisplayed: 3,
            disableIfEmpty: false,
            templates: {
                button: '<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown" style="width:300px;"></button>',
